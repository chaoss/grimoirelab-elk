...
class TestLaunchpad(TestBaseBackend):
    ...
    def test_raw_to_enrich(self):
        ...
        self.assertEqual(eitem['created_to_assigned'], None)
        self.assertEqual(eitem['assigned_to_closed'], None)
        self.assertEqual(eitem['time_to_close_days'], None)
        self.assertEqual(eitem['time_to_last_update_days'], 2041.07)
        ...
        self.assertEqual(eitem['time_to_first_activity'], None)
        self.assertEqual(eitem['activity_count'], 1)
        self.assertEqual(eitem['is_launchpad_message'], 1)
        ...
        self.assertEqual(eitem['assigned_to_closed'], None)
        self.assertEqual(eitem['time_to_close_days'], None)
        self.assertEqual(eitem['time_to_last_update_days'], 25.48)
        ...
        self.assertEqual(eitem['user_karma'], 1841)
        self.assertEqual(eitem['user_time_zone'], 'America/Santiago')
        self.assertEqual(eitem['assignee_login'], None)
        self.assertEqual(eitem['assignee_name'], None)
        self.assertEqual(eitem['assignee_joined'], None)
        self.assertEqual(eitem['assignee_karma'], None)
        self.assertEqual(eitem['assignee_time_zone'], None)
        self.assertEqual(eitem['bug_name'], None)
        ...
        self.assertEqual(eitem['date_triaged'], None)
        self.assertEqual(eitem['date_left_new'], None)
        self.assertEqual(eitem['created_to_assigned'], 441.68)
        self.assertEqual(eitem['assigned_to_closed'], -441.68)
