...
class TestScmsMbox(TestBaseBackend):
    """Test ScmsMbox backend"""
    ...
    def test_raw_to_enrich(self):
        ...
        self.assertEqual(result['raw'], 15)
        self.assertEqual(result['enrich'], 15)
        ...
        self.assertEqual(eitem['context'], "[List-name] Protocol Buffers anyone?")
        ...
        eitem = enrich_backend.get_rich_item(item)
        self.assertEqual(eitem['data_source'], "Mbox")
        self.assertEqual(eitem['context'], "Re: Revisiting the Gnome Bindings")

        item = self.items[3]
        eitem = enrich_backend.get_rich_item(item)
        self.assertEqual(eitem['data_source'], "Mbox")
        self.assertEqual(eitem['context'], "Re: Low memory hacks")
