...
from grimoire_elk.raw.puppetforge import PuppetForgeOcean
...
class TestPuppetForge(TestBaseBackend):
    ...
    def test_arthur_params(self):
        ...
        with open("data/projects-release.json") as projects_filename:
            url = json.load(projects_filename)['grimoire']['puppetforge'][0]
            arthur_params = {'uri': '', 'url': ''}
            self.assertDictEqual(arthur_params, PuppetForgeOcean.get_arthur_params_from_url(url))
