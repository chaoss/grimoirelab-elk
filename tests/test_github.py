...
class TestGitHubEvents(TestBaseBackend):
    """Test GitHub backend"""
    ...
    def setUp(self):
        with open(os.path.join("data", self.connector + "_events.json")) as f:
    ...
    def test_raw_to_enrich(self):
        ...
        self.assertEqual(eitem['author_uuid'], '6f29174b25521cf9477a4431b24c0078f52fb001')
